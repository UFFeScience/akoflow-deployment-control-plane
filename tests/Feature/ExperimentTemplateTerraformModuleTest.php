...
class ExperimentTemplateTerraformModuleTest extends TestCase
{
    use RefreshDatabase;
    ...
    private function base(ExperimentTemplate $t, ExperimentTemplateVersion $v): string
    {
        return "/api/experiment-templates/{$t->id}/versions/{$v->id}/terraform-modules";
    }
    ...
    public function test_index_returns_all_modules_for_version(): void
    {
        ...
        ExperimentTemplateTerraformModule::create([
    ...
    public function test_user_can_create_aws_module(): void
    {
        ...
        $this->assertDatabaseHas('experiment_template_terraform_modules', [
            'template_version_id' => $version->id,
            'provider_type'       => 'aws',
            'module_slug'         => 'aws_nvflare',
        ]);
    ...
    public function test_same_version_can_have_aws_and_gcp_modules(): void
    {
        ...
        $this->assertDatabaseCount('experiment_template_terraform_modules', 2);
    }
    ...
    public function test_user_can_set_tfvars_mapping_and_credential_env_keys(): void
    {
        ...
        $module = ExperimentTemplateTerraformModule::where('template_version_id', $version->id)
    ...
    public function test_show_returns_404_when_no_terraform_module_for_version(): void
    {
        ...
        $response = $this->withHeaders($this->authHeader($user))
            ->getJson("/api/experiment-templates/{$template->id}/versions/{$version->id}/terraform-module");
