...
class CreateDeploymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'provider_credentials'                 => 'required|array|min:1',
            'provider_credentials.*.provider_id'   => 'required|integer|exists:providers,id',
            'provider_credentials.*.credential_id' => 'nullable|integer|exists:provider_credentials,id',
