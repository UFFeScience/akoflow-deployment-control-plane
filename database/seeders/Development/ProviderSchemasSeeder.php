        ...
        $schemasBySlug = [
            ...
            'local' => [
                [
                    ...
                    'name'          => 'host',
                    'label'         => 'Host / IP',
                    'description'   => 'Hostname or IP address of the target machine (e.g. 192.168.1.10 or myserver.local).',
                    'type'          => 'string',
                    'required'      => true,
                    'is_sensitive'  => false,
                    'position'      => 1,
                ...
                [
                    ...
                    'name'          => 'user',
                    'label'         => 'SSH User',
                    'description'   => 'Username used to authenticate via SSH (e.g. root or ubuntu).',
                    'type'          => 'string',
                    'required'      => true,
                    'is_sensitive'  => false,
                    'position'      => 2,
                ...
                [
                    ...
                    'name'          => 'ssh_password',
                    'label'         => 'SSH Password',
                    'description'   => 'Password for SSH authentication. Use this OR the private key — not both.',
                    'type'          => 'secret',
                    'required'      => false,
                    'is_sensitive'  => true,
                    'position'      => 3,
                ...
                [
                    ...
                    'name'          => 'ssh_private_key',
                    'label'         => 'SSH Private Key',
                    'description'   => 'PEM/RSA private key for SSH authentication. Use this OR the password above — not both.',
                    'type'          => 'textarea',
                    'required'      => false,
                    'is_sensitive'  => true,
                    'position'      => 4,
