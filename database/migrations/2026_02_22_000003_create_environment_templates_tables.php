...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('environment_template_versions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('template_id')->constrained('environment_templates')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('environment_template_versions');
